"""Qt-like signal/slot implementation that is safe to use from Slicer Python.

Copied verbatim from SlicerNNUnet (SlicerNNUNetLib/Signal.py).  Using real
``qt.Signal`` objects from PythonQt leads to application crashes, see
https://discourse.slicer.org/t/custom-signal-slots-with-pythonqt/3278/5
"""
...
class Signal(object):
    """Qt like signal slot connections."""
